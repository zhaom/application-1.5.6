...
JAVA_OPTS="-Djava.net.preferIPv4Stack=true -Xms512m -Xmx512m -Xmanagement:ssl=false,authenticate=false,autodiscovery=false,port=7095"

#APP_OPTS="-l $2 -m $3"

MAIN_CLASS="com.babeeta.butterfly.subscription.service.SubscriptionServer"
